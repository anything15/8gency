(function ($) {
    ...
    /** Mouse Cursor **/
    function agencyMouseCursor(init) {
    ...
    function agencyDynamicList() {

        let list = $('.agency-dynamic-list');
        ...
        list.each(function () {
            ...
            item.each(function () {
                ...
                animation ? new agencyTextAnimation($this.find('a')) : '';
    ...
    function siteNavigation() {
        ...
        function classicNavigation() {
            ...
            if (nav.hasClass('one-page')) {
                ...
                nav.children('ul').children('li').each(function () {
                    ...
                    $this.find('a').addClass('agency-scroll-button');
            ...
            let hasChild = nav.find('.main-menu').children('.agency-has-children');
            ...
            setTimeout(function () {
                ...
                hasChild.each(function (i) {
                    ...
                    $this.find('.agency-sub-menu-wrap').addClass('sub_' + i).insertBefore(siteHeader)
        ...
        function menuToggle(targetMenu) {
            ...
            setTimeout(function () {
                ...
                let navTweens = gsap.getTweensOf(targetMenu.find('*').not('.main-menu *, .agency-button, .agency-button *')),
                    i = 0,
                    tltl = gsap.timeline({
                        id: 'fs_menu_tl'
                    });
    ...
    function agencyGeneralAnims(target) {

        target.each(function () {

            let $this = $(this);

            new agencyGeneralAnimations($this)
    ...
    function agencyImageAnims() {

        $('.has-anim-image').each(function () {


            let $this = $(this);
            new agencyImageAnimation($this);
    ...
    function agencyTextAnims() {
        ...
        hasAnim.not(exclude).each(function () {
            ...
            let textAnim = new agencyTextAnimation($this);
        ...
        list.each(function () {
            ...
            if (animation) {
                ...
                listItem.each(function () {
                    ...
                    let anim = new agencyTextAnimation($this);
    ...
    function agencyProjectPages() {
        ...
        let nextProj = $('.agency-next-project'),
    ...
    function agencyShopPage() {

        let products = $('.agency-products-grid');
    ...
    function showcaseFullscreenCarousel() {
        ...
        showcaseFullscreenCarousel.each(function (i) {
            ...
            imagesWrap.find('.agency-video').each(function () {
    ...
    function showcaseInfiniteGrid() {
        ...
        fullscreenGrid.each(function (i) {
            ...
            lenis.on('scroll', (e) => {
                var bgMarquee = gsap.getById('agency_marquee'),
    ...
    function layoutSwitcher() {
        ...
        let switcher = $('.agency-layout-switcher'),
    ...
    function agencyCartButton() {

        var button = $('.agency-cart-button');
    ...
    agencyProductRatings()

    function agencyAddTocartButton() {
    ...
    agencyAddTocartButton()


     function agencyLightboxGallery(gallery, items) {
                ...
                function createNav(range, length, index) {
                    ...
                    //NavbyWheel
                    thumbsWheeler = Hamster(document.querySelector('.agency-lightbox-hold'));
                    var xVal = currX;
    ...
    function agencyDynamicGrid() {

        const grid = $('.agency-dynamic-grid');
        ...
        grid.each(function () {
            ...
            grid.hasClass('lightbox-gallery') ? agencyLightboxGallery(wrapper, items) : '';
            ...
            items.each(function (i) {
                ...
                if (animation != null) {
                    ...
                    grid.hasClass('image-grid') ? new agencyImageAnimation($this) : new agencyGeneralAnimations($this);
    ...
    function agencyFilterableGrid() {

        let $scope = $('.agency-filterable-grid'),
    ...
    function agencyDynamicCarousel() {
        const carousel = $('.agency-dynamic-carousel');
        ...
        carousel.each(function () {
            ...
            items.each(function (i) {
                ...
                if (animation != null) {
                    ...
                    carousel.hasClass('image-carousel') ? new agencyImageAnimation($this) : new agencyGeneralAnimations($this);
    ...
    function agencyIcons() {

        $('.agency-icon').each(function () {
    ...
    function agencyVideo(vid) {
        ...
        if ((video.length) && (!video.hasClass('vid-ready'))) {
            ...
            video.each(function (i) {
                ...
                const agencyVid = new Plyr(video, {
                    controls: controls,
                    clickToPlay: true,
                    autopause: false,
                    debug: false,
                ...
                if (!$this.hasClass('n-self')) {
                    agencyVid.autoplay = nautoplay
                    agencyVid.muted = nmuted
                    agencyVid.loop = nloop
                }



                agencyVid.on('ready', (event) => {
                    ...
                    $this.find('.plyr').addClass('agency_video_' + i);
                    $this.addClass('agency-fake-running');

                    let vid = $('.agency_video_' + i);



                    vid.find('.plyr__video-wrapper').addClass('agency-video-wrap');
                    vid.find('.plyr__controls').addClass('agency-controls-wrap');

                    vid.find('.plyr__control[data-plyr="play"]').append('<span class="hover-default agency-player-control agency-play">' + playText + '</span><span class="hover-default agency-player-control agency-pause">' + pauseText + '</span>')

                    vid.find('.plyr__controls__item.plyr__volume button[data-plyr="mute"]').append('<span class="hover-default agency-player-control agency-mute">' + muteText + '</span><span class="hover-default agency-player-control agency-unmute">' + unmuteText + '</span>');

                    if ($this.hasClass('play-inner')) {

                        $this.find('.agency-play-button').on('click', function () {
                            ...
                            if ($this.hasClass('lightbox-play')) {
                                ...
                                agencyVid.muted = false;
                                agencyVid.restart();
                                agencyVid.play();
                                $this.addClass('agency-running');
                                $this.removeClass('agency-fake-running');
                    ...
                    if ($this.hasClass('play-cursor')) {
                        ...
                        $this.on('click', function () {
                            ...
                            if ($this.hasClass('lightbox-play')) {
                                ...
                                if ($this.hasClass('agency-fake-running')) {
                                    $this.removeClass('cursor-icon');
                                    $this.removeClass('cursor-text');
                        ...
                        $this.on('mouseenter', function () {
                            if ($this.hasClass('agency-running')) {
                    ...
                    function lightboxPlay() {
                        ...
                        if ($this.hasClass('ratio-adjusted')) {
                            ...
                            let $iframe = $('.nlv').find('.agency-video-wrap');
                        ...
                        $('.lightbox-close').on('click', function () {
                            ...
                            gsap.to('.nlv', {
                                ...
                                onComplete: () => {
                                    ...
                                    vid.find('.plyr__video-wrapper').removeClass('agency-video-wrap');
                                    vid.find('.plyr__controls').removeClass('agency-controls-wrap');

                                    agencyVid.muted = true;

                                    vid.prependTo($this);

                                    $this.removeClass('agency-running');
                                    $this.addClass('agency-fake-running');
                            ...
                            if ($this.hasClass('ratio-adjusted')) {
                                ...
                                $this.attr('ratio', agencyVid.ratio);

                                let rat = agencyVid.ratio.split(':')[0] / agencyVid.ratio.split(':')[1],
                                ...
                                if (parentRatio < rat) {
                                    ...
                                    function adjustIframeSize() {
                                        ...
                                        const $iframe = $this.find('.agency-video-wrap');
    ...
    function agencyHeading() {


        let heading = $('.agency-heading');
    ...
    function agencyCircleText() {

        let circularText = $(".agency-circular-text");
    ...
    function agencyButtons() {

        var button = $('.agency-button');
        ...
        button.each(function () {
            ...
            if (animation) {
                ...
                new agencyTextAnimation($this.find('.button-anim-holder'))
    ...
    function agencyMarquee(i) {

        var velocity;
        let marquee = $('.agency-marquee');
        ...
        marquee.each(function () {
            ...
            window.onresize = function () {
                $this.find('.agency-marquee:first-child').nextAll().remove()
    ...
    function agencyServices() {
        let agencyServices = $('.agency-services');

        agencyServices.each(function () {

            let services = $(this),
                servicesItem = services.find('.agency-service');

            servicesItem.append("<span class='services-item-bottom-line agency-service-line'></span>")
    ...
    function agencyAccordion() {
        let agencyAccordion = $('.agency-accordion');

        agencyAccordion.each(function () {
            let $this = $(this),
            ...
            if (animation) {
                ...
                new agencyTextAnimation(acrdTitle.children('span'))
            }
    ...
    function agencyClinetsCarousel() {

        let clientCarousel = $('.agency-clients-carousel');
    ...
    function agencyInfiniteCarousel() {

        let clientCarousel = $('.agency-infinite-carousel');
    ...
    function agencyTestimonials() {
        ...
        let testimonials = $('.agency-testimonials');
    ...
    function agencyScrollButtons() {

        let button = $('.agency-scroll-button')
    ...
    function agencyNumberCounter() {

        let numberCt = $('.agency-number-counter');
    ...
    function agencyTeamMember() {

        const member = $('.agency-team-member');
    ...
    function agencyInfiniteTabs() {
        let agencyInfiniteTab = $('.agency-infinite-tabs');

        agencyInfiniteTab.each(function () {
            let $this = $(this),
    ...
    function initPages() {
        $('.project-page').length ? agencyProjectPages() : '';
        agencyPortfolio();
        agencyProductPage();
        agencySinglePostPage()
    ...
    function initPageElements() {
        ...
        agencyAccordion();
        agencyInfiniteTabs();
        agencyClinetsCarousel();
        agencyInfiniteCarousel();
        agencyDynamicGrid();
        agencyFilterableGrid();
        agencyForms();
        gridScroll()
        agencyTestimonials()
        //                agencyImageCompare()

        agencyDynamicCarousel();
        agencyParallax();
        agencyLightbox()
        agencyDynamicList();
        detectPov()
    ...
    $(window).on('load', function () {
        ...
        agencyVideo($('.agency-video'));
        agencyGeneralAnims($('.has-anim'));
        agencyTextAnims();
        agencyTextWrapper();
        agencyListAnimations();
        agencyImageAnims()
        agencyParallaxImages();
    ...
    let transitions = $('.agency-page-transition'),
        ...
        transitions: [
            {
                ...
                beforeEnter(data) {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        let styleSheet = $(response).filter('style#agency-body-styles')[0];
                ...
                leave(trigger) {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        if (media.find('.agency-video').length) {
    ...
    barba.hooks.enter((data) => {
        ...
        agencySmoother == true ? $('body').addClass('smooth-scroll') : '';
    ...
    barba.hooks.after((data) => {
        ...
        agencyTextAnims();
        agencyTextWrapper();
        agencyGeneralAnims($('main .has-anim'));
        ...
        agencySections();
        initPages();
        agencyVideo($('#primary').find('.agency-video'));

        ScrollTrigger.refresh(true);
        agencyMouseCursor(false);
    ...
    $(document).ready(function () {
        ...
        // Package.json loading removed for production
